...
public static class SteeringBehaviours
{
    ...
    // public static Vector3 Pursue(Transform self, Transform target, Rigidbody targetRb, float time)
    // {
    ...
    // public static Vector3 Evade(Transform self, Transform target, Rigidbody targetRb, float time)
    // {
    //     Vector3 futurePos = target.position + targetRb.linearVelocity * time;
